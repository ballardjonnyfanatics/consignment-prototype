...
export function ConfirmationStep() {
  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="relative flex flex-col gap-1.5 rounded-xl bg-[var(--ds1-main-bg-layer-2)] p-4">
        <span className="text-base font-bold">Ship to</span>
      ...
      <button className="flex w-full items-center justify-center rounded-full border border-[var(--ds1-main-border-primary)] py-4 text-base font-bold transition-colors hover:bg-[var(--ds1-main-bg-fill-alpha)]">
